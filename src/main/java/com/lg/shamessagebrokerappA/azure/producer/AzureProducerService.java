...
public class AzureProducerService {
    ...
    @Value("${azure.dhis2Queue}")
    String dhis2Queue;

    @Value("${azure.openMRSQueue}")
    String openMRSQueue;

    private AzureProducerSender mqSender = new AzureProducerSender();
    private AzureProducerRefresh mqRefresh = new AzureProducerRefresh(this);
     ...
     * 
     * @return boolean The connection status of Azure
     */

    public Boolean createSession() {
        Boolean returnValue = mqSender.connect(brokerURL);
